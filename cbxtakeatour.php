...
defined( 'CBXTAKEATOUR_PLUGIN_VERSION' ) or define( 'CBXTAKEATOUR_PLUGIN_VERSION', '1.2.1' );
...
defined( 'CBXTAKEATOUR_PRO_VERSION' ) or define( 'CBXTAKEATOUR_PRO_VERSION', '1.2.1' );
 ...
 */
function cbxtakeatour_activate() {
...
}//end function cbxtakeatour_activate

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/CBXTakeaTourDeactivator.php
 */
function cbxtakeatour_deactivate() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/CBXTakeaTourDeactivator.php';
	CBXTakeaTourDeactivator::deactivate();
}//end function cbxtakeatour_deactivate

register_activation_hook( __FILE__, 'cbxtakeatour_activate' );
register_deactivation_hook( __FILE__, 'cbxtakeatour_deactivate' );
...
function cbxtakeatour_core() { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	...
	if ( ! isset( $cbxtakeatour_core ) ) {
		$cbxtakeatour_core = cbxtakeatour_run_core();
	}
 ...
 * @since    1.1.1
 */
function cbxtakeatour_run_core() {
	return CBXTakeaTour::instance();
}

$GLOBALS['cbxtakeatour_core'] = cbxtakeatour_run_core();